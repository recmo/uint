...
- Implement shifts and shift assignments for all primitive integer types on every target, including `u64`/`i64` on 32-bit targets and `u128`/`i128`, without truncating oversized shift amounts
